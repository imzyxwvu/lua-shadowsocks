--
--  ZyWebD Under-construction Branch Version - simplified
--  (c) 2015 zyxwvu <imzyxwvu@icloud.com>
--
local uv = require "xuv"
local lfsattr, band = require "lfs".attributes, (bit32 or bit).band
	...
	while true do
		...
		if request then
			...
			if s then
				...
				if res.headerSent then print(err) return res:Close() else
